      ...
      <div className="grid w-full grid-cols-2">
        ...
        <div className="flex flex-col items-center justify-center">
          <motion.div
            ...
            className="relative w-2/3 p-6 bg-gray-900 rounded-lg h-3/4 gap-y-6"
          >
            ...
            <button
              type="button"
              disabled
              className="w-full px-8 py-2 text-lg rounded bg-primary focus:outline-none hover:bg-primary/80"
            >
